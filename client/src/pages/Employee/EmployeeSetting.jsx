...
  Tabs,
  CircularProgress,
  Link as MuiLink, // <-- 1. Import Link as MuiLink
} from "@mui/material";
...
// 2. Standardized primaryButtonStyle (using provided structure)
...
  };
  
  // Style for the Dashboard button, adjusting py and px to be consistent with the 40px height from the prior response
  const dashboardButtonStyle = {
    ...primaryButtonStyle,
    height: 40,
    py: 0.5, // Adjust vertical padding for fixed height
    px: 3,
  };
...
        
        {/* Header (MODIFIED to include the Dashboard button) */}
...
          </Box>
          
          {/* NEW Dashboard Button (Right Side) */}
          <Button
            component={MuiLink}
...
                </Grid>
                <Grid item xs={12} md={6}>
                  <TextField label="Employee ID" fullWidth value={user.employeeId} sx={themedInputStyle} />
                </Grid>
                <Grid item xs={12} md={6}>
...
                    <Box>
                      <Typography fontWeight="medium" color="white">Notification Configuration</Typography>
