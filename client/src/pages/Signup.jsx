      ...
      endAdornment: (
        <InputAdornment position="end">
          <IconButton
            ...
            edge="end"
            sx={{
              color: "gray", // 👈 makes icon white
              p: 1.5, // less padding for compact look
              "&:hover": {
                color: "#00ffcc", // 👈 slight glow effect on hover
              },
            }}
          >
            {showPassword ? (
  ...
  />
              ...
              <Box sx={{ mb: 2 }}>
                <FormControl fullWidth>
                  <InputLabel id="role-select-label" sx={{ color: "#9ca3af" }}>
                    Role
                  </InputLabel>
                  <Select
